...
// TarBZIP2 handles bzip2 files
type TarBZIP2 struct {
	filters []string
}

// Install file from bzip2 file
func (x TarBZIP2) Install(src, dst, version string, mapper mapping.Mapper) error {
	...
	r, err := bzip2.NewReader(bytes.NewReader(data), 0)
	if err != nil {
		return err
	}
